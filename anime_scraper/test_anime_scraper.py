...
def test_get_reviews(my_list):
  append_page_number_to_url(my_list, 2)
  get_reviews(my_list)
  assert len(my_list['https://www.crunchyroll.com/one-piece/reviews/helpful/page']['reviews']) == 10
  assert len(my_list['https://www.crunchyroll.com/my-hero-academia/reviews/helpful/page']['reviews']) == 10